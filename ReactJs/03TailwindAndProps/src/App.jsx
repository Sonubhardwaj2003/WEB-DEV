import "./App.css";
import Card from './componentcartProp/Card';


function App() {
  return (
    <>
      <h1 className="bg-slate-600 font-black text-white rounded-xl">
        Hello world!
      </h1>
      <p className="font-bold bg-orange-300 text-black rounded-2xl">
        Applied tailwind css in react seccussfully
      </p>
      --------
      {/* <div class="my-10 relative grid min-h-screen grid-cols-[1fr_2.5rem_auto_2.5rem_1fr] grid-rows-[1fr_1px_auto_1px_1fr] bg-white [--pattern-fg:var(--color-gray-950)]/5 dark:bg-gray-950 dark:[--pattern-fg:var(--color-white)]/10">
      ...
      <div>
        <div class="flex items-center space-x-2 text-base bg-white">
          <h4 class="font-semibold text-slate-900">Contributors</h4>
          <span class="rounded-full bg-slate-100 px-2 py-1 text-xs font-semibold text-slate-700">
            204
          </span>
        </div>
        <div class="flex -space-x-2 overflow-hidden bg-white">
          <img
        ...
        <div class="md-3 text-sm font-medium bg-white">
      ...
      <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4 my-10">
        <Card
          title="Space"
          description="Explore how recursive selection sort works with visual examples and code walkthroughs."
          imageUrl="https://www.pixelstalk.net/wp-content/uploads/2016/11/Earth-From-Space-HD-Backgrounds.jpg"
      ...
      <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
        <Card
          title="Yellow Tree garden"
          description="Explore how recursive selection sort works with visual examples and code walkthroughs."
          imageUrl="https://www.pixelstalk.net/wp-content/uploads/2016/07/Background-Beautiful-Nature-Images-HD.jpg"
          buttonText="Learn More"
        />
      </div>
